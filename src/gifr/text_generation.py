...
def create_interface() -> gr.Interface:
    ...
    return gr.Interface(
        ...
        description="Sends the entered text to the model to complete and displays the result.",
        fn=predict,
        inputs=[
...
def main(args=None):
    ...
    parser = create_parser("Text generation interface. Allows the user to enter text "
                           ...
                           PROG, model_channel_in="text", model_channel_out="prediction", timeout=1.0)
